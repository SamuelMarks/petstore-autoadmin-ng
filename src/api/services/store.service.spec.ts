...
describe('StoreService', () => {
    ...
    describe('placeOrder()', () => {
        it('should return Order on success', () => {
            const mockResponse: Order = { "id": 123, "petId": 123, "quantity": 123, "shipDate": "2025-11-13T20:12:46.054Z", "status": "string-value", "complete": true };
            const order: Order = { "id": 123, "petId": 123, "quantity": 123, "shipDate": "2025-11-13T20:12:46.055Z", "status": "string-value", "complete": true };
    ...
    describe('getOrderById()', () => {
        it('should return Order on success', () => {
            const mockResponse: Order = { "id": 123, "petId": 123, "quantity": 123, "shipDate": "2025-11-13T20:12:46.055Z", "status": "string-value", "complete": true };
            const orderId = 123;
