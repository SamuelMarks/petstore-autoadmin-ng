...
describe('PetService', () => {
    ...
    describe('addPet()', () => {
        it('should return any on success', () => {
            ...
            const pet: Pet = { "id": 123, "category": { "id": 123, "name": "string-value" }, "name": "doggie", "photoUrls": ["string-value"], "tags": [{ "id": 123, "name": "string-value" }], "status": "string-value" };
    ...
    describe('findPetsByStatus()', () => {
        it('should return Pet[] on success', () => {
            const mockResponse: Pet[] = [{ "id": 123, "category": { "id": 123, "name": "string-value" }, "name": "doggie", "photoUrls": ["string-value"], "tags": [{ "id": 123, "name": "string-value" }], "status": "string-value" }];
