...
export class StoreService {
   ...
   * @param options The options for this request, with response observation enabled.
   */
  deleteOrder(orderId: number, options: RequestOptions & { observe: 'response' }): Observable<HttpResponse<unknown>>;
  /**
   * deleteOrder.
   * @param orderId
   * @param options The options for this request, with event observation enabled.
   */
  deleteOrder(orderId: number, options: RequestOptions & { observe: 'events' }): Observable<HttpEvent<unknown>>;
  /**
   * deleteOrder.
   * @param orderId
   * @param options The options for this request, with a blob response type.
   ...
   * @param options The options for this request.
   */
  deleteOrder(orderId: number, options?: RequestOptions & { observe?: 'body' }): Observable<unknown>;
  /**
