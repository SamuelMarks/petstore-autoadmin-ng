...
export class StoreService {
     ...
     */
    getInventory(options?: RequestOptions & { observe?: 'body' | 'events' | 'response', responseType?: 'arraybuffer' | 'blob' | 'json' | 'text' }): Observable<any> {
    ...
    placeOrder(order?: Order, options?: RequestOptions & { observe?: 'body' | 'events' | 'response', responseType?: 'arraybuffer' | 'blob' | 'json' | 'text' }): Observable<any> {
     ...
     */
    getOrderById(orderId: number, options?: RequestOptions & { observe?: 'body' | 'events' | 'response', responseType?: 'arraybuffer' | 'blob' | 'json' | 'text' }): Observable<any> {
     ...
     */
    deleteOrder(orderId: number, options?: RequestOptions & { observe?: 'body' | 'events' | 'response', responseType?: 'arraybuffer' | 'blob' | 'json' | 'text' }): Observable<any> {
        const url = `${this.basePath}/store/order/${orderId}`;
        const requestOptions: any = {
          observe: options?.observe,
          reportProgress: options?.reportProgress,
